...
class CreateFirstIblock extends AbstractMigration
{

    static $iblockType = CreateTypeIblock::idTypeIblock; // Тип инфоблока
    static $siteId = "s1"; // ID сайта
    static $codeName = "first_iblock"; // Код инфоблока
    static $nameIblock = "Первый инфоблок"; // Имя инфоблока
